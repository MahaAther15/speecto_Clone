...
const Hero = () => {
    return (
        <div className="w-full items-center justify-center flex bg-lightBg dark:bg-darkBg 2xl:max-h-[550px] 2xl:min-h-[550px] md:max-h-[500px] md:min-h-[500px] min-h-[550px] max-h-none md:max-h-[550px] overflow-hidden relative undefined">
            <div className="bg-lightBg dark:bg-darkBg w-full pt-[70px] sm:pt-[80px] pb-10 md:pb-5 h-full max-h-none md:max-h-full overflow-hidden">
                <div className="container h-full relative grid grid-cols-1 items-center ">
                    <div className="grid md:grid-cols-2 grid-cols-1 2xl:gap-[0] md:gap-x-[10%] gap-3">
                        ...
                        <div className="md:col-start-2 md:row-start-1 w-full mx-auto row-start-2 md:row-span-2 md:mt-0 -mt-3 flex items-center justify-center overflow-hidden">
                            <OrbitAnimation />
                        </div>
                    </div>
                </div>
