                ...
                <div className="min-h-full grid gap-3 md:grid-cols-2 md:gap-[2.27%] md:items-center">
                    <div className="!z-[99] md:text-left text-center">
                        <h1 className="2xl:text-5xl lg:text-4xl font-Nunito md:text-3xl text-2xl text-primary font-bold !text-white uppercase">
                            Product/SAAS <span className="!text-transparent !bg-clip-text bg-buttontextGradient">Development</span>
                        </h1>
                            ...
                            <span style={{ boxSizing: "border-box", display: "inline-block", overflow: "hidden", width: "initial", height: "initial", background: "none", opacity: 1, border: "0px", margin: "0px", padding: "0px", position: "relative", maxWidth: "100%" }}>
                                <span style={{ boxSizing: "border-box", display: "block", width: "initial", height: "initial", background: "none", opacity: 1, border: "0px", margin: "0px", padding: "0px", maxWidth: "100%" }}>
                                    <img 
                                        alt="" 
                                        aria-hidden="true" 
                                        src="data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%27521%27%20height=%27479%27/%3e" 
                                ...
                                <img 
                                    alt="Product/SAAS Development illustration" 
