...
const Detail = () => {
    return (
        <div className="container flex md:text-base text-sm items-center gap-[10px]">
            <Link className="text-gray5" title="link" to="/services">
                Our services
            </Link>
            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" className="text-gray5" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="font-bold !font-Nunito">Web App Development</p>
        </div>
    );
};
