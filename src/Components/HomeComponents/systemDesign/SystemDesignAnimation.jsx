  ...
  return (
    <div className="w-full h-full flex items-center justify-center overflow-hidden lg:overflow-visible">
      ...
      >
        ...
        <line x1="210" y1="72" x2="210" y2="90" stroke="#b0b8d0" strokeWidth="1.5" />
      </svg>
      ...
      <div className="sda-monitor">
        ...
        <div className="sda-screen">
          <img className="w-10 ml-10 mb-10" src={systemDesignLine1} alt="" />
          {/* Big central gear */}
          ...
          <img className="w-15 mr-8 mt-45" src={systemDesignLine2} alt="" />
          {/* Top-right gear */}
      ...
      <div className="sda-code-bubble">
        <img src={systemDesignMessage} alt="" />
      </div>
