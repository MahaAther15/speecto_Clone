  ...
  return (
    <div className="flex flex-col items-center bg-white lg:px-1 py-5 w-full max-w-full overflow-hidden lg:overflow-visible">
      ...
      <div className="flex flex-col items-center mb-2">
        <div className="relative  !text-white 2xl:text-2xl lg:text-xl sm:text-lg text-base font-Nunito font-bold rounded-full sm:w-[50px] sm:h-[50px] w-10 h-10 md:w-[60px] md:h-[60px]  flex  items-center justify-center  dark:text-black text-white bg-gradient-to-r from-[#554bac] to-[#8c99e3]  font-bold shadow-lg mb-4">
          3
        </div>

        <h2 className="lg:text-[28px] sm:text-2xl mt-3 2xl:text-[32px]    text-xl font-bold font-Nunito   r!mb-10 !text-transparent   bg-clip-text lg:tracking-[0.2em]  tracking-[0.1em] 2xl:tracking-[0.3em] !uppercase  bg-gradient-to-r from-[#554bac] to-[#8c99e3] bg-clip-text text-transparent">
          SYSTEM DESIGN
        </h2>
      </div>
