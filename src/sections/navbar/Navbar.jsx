...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <div className={`py-5 left-0 w-full transition-all !duration-500 !z-[1000001] bg-[#081533] ${isScrolled ? "fixed top-0 animate-navSticky bg-opacity-95" : "absolute"
                }`}>
                    ...
                    <div className="container flex items-center justify-between w-full gap-3 mx-auto lg:gap-5 px-6">
                        ...
                        <div className="items-center justify-center hidden w-full gap-1 lg:flex md:gap-2 lg:gap-5 xl:gap-8 2xl:gap-[50px]">
                            <NavLink to="/" title="link">
                                {({ isActive }) => (
                                    <p className={`font-Nunito 2xl:text-xl xl:text-lg text-base font-medium relative flex justify-center font-Nunito transition-all ${isActive
                        ...
                        <div className="flex items-center gap-3">
                            <div className="min-w-[40px] sm:min-w-[60px]">
                                ...
                                >
                                    ...
                                    <div
                                        className={`opacity-100 scale-100 !shadow-serviceCardShadow bg-yellow-300 transition-all duration-300 w-[15px] h-[15px] sm:w-[20px] sm:h-[20px] absolute top-1/2 -translate-y-1/2 rounded-full overflow-hidden ${theme === "dark"
            ...
            <div
                ...
                className={`w-full h-full min-h-[calc(100vh+100px)] top-0 left-0 fixed bg-black/70 z-[99999] transition-opacity duration-300 ${menuOpen ? "opacity-100 block" : "opacity-0 hidden"
                    }`}
            ></div>
